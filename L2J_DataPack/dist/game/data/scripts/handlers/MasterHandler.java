...
public class MasterHandler
{
	...
	private static final Class<?>[][] _handlers = 
	{
		...
		{ // Admin Command Handlers
			...
			AdminVitality.class,
			AdminZone.class,
                        (Config.VAEMOD_ADMINMONSTER ? AdminMonster.class : null),
                        (Config.VAEMOD_ADMINRBJAIL ? AdminRBjail.class : null),
                        (Config.VAEMOD_ADMINDEBUFF ? AdminDebuff.class : null),
                        (Config.VAEMOD_MOVIE ? AdminMovie.class : null),
                        (!Config.VAEMOD_ADMINMESSAGEAREA.equalsIgnoreCase("OFF") ? AdminMessage.class : null),
                        (Config.VAEMOD_NPCSAY ? AdminNpcSay.class : null),
                        (Config.VAEMOD_PENALTY ? AdminPenalty.class : null),
                        (Config.VAEMOD_SCENE ? AdminScene.class : null),
		},
		{ // Bypass Handlers
			Augment.class,
			ArenaBuff.class,
		...
		{ // Voiced Command Handlers
			...
			(Config.L2JMOD_HELLBOUND_STATUS ? Hellbound.class : null),
                        (Config.VAEMOD_DESC ? Desc.class : null),
                        (Config.VAEMOD_FSDAMAGES ? Damages.class : null),
                        (Config.VAEMOD_TITLE ? Title.class : null),
                        (Config.VAEMOD_RPLANG ? Language.class : null),
                        (Config.VAEMOD_CHATVOLUME ? ChatVolume.class : null),
                        (Config.VAEMOD_RPTIME ? RPTime.class : null),
                        (Config.VAEMOD_VOTESCHECK > 0 ? VotesReminder.class : null),
                        (Config.VAEMOD_PETSAY ? PetSay.class : null),
                        (Config.VAEMOD_CAMP ? Camp.class : null),
                        (Config.VAEMOD_METEO ? Meteo.class : null),
		},
		{ // Target Handlers
			TargetAlly.class,
			TargetArea.class,
