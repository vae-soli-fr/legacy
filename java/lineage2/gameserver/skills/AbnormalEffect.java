...
public enum AbnormalEffect
{
	...
	S_47("s_47", 0x004000, 47), // boule verte au dessu de la tete
	S_48("s_48", 0x008000, 48), // energie bleue
	S_HELLBINDING("hellbinding", 0x010000, 49), // boule rouge en l'air
	S_50("s_50", 0x020000, 50), // ?
	S_51("s_51", 0x040000, 51), // tord de douleur parterre
	S_52("s_52", 0x080000, 52), // FAIT PLANTER
	S_53("s_53", 0x100000, 53), // ?
	S_54("s_54", 0x200000, 57), // energie jaune
	S_55("s_55", 0x400000, 55), // ?
	S_56("s_56", 0x800000, 56), // cage magique
	S_57("s_57", 0x1000000, 57), // energie jaune
	S_58("s_58", 0x2000000, 58), // energie jaune
	S_59("s_59", 0x4000000, 59), // boule rouge
	S_60("s_60", 0x8000000, 60), // energie rouge
	S_61("s_61", 0x10000000, 61), // flash lumineux
