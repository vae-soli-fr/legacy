...
public class Experience
{
	public final static long LEVEL[] =
	{
		...
		4211039578L,
		5078544041L,
		Math.round(10985069426L*1.6),
		Math.round(19192594397L*1.6),
		Math.round(33533938399L*1.6),
		Math.round(43503026615L*1.6),
		Math.round(61895085913L*1.6),
		Math.round(84465260437L*1.6),
		Math.round(112359133751L*1.6),
		Math.round(146853833970L*1.6),
		Math.round(189558054903L*1.6),
		Math.round(242517343994L*1.6),
		Math.round(343490462139L*1.6),
		Math.round(538901012155L*1.6),
		Math.round(923857608218L*1.6),
		Math.round(1701666675991L*1.6),
		Math.round(1801666675991L*1.6)
	};
