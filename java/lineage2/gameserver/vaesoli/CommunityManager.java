...
public class CommunityManager {
	...
	public void refreshCommunityBoard() {
		FastList<Player> sortedPlayers = new FastList<>();
	...
	private void writeCommunityPages() {
		...
		htmlCode.append("<html><title>Communauté</title><body><br>" + "Serveur redémarré " + formater.format(GameServer.getInstance().serverStarted())
				+ "<table>" + trOpen + tdOpen
