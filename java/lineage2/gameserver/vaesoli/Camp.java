...
public class Camp
{
	...
	private final ArrayList<SimpleSpawner> _spawns;
	private final ArrayList<NpcInstance> _npcs;
	...
	/**
	 * Based on the state of active char's camp, figures out which element to spawn, remove, etc. Called through .camp.
	 * @param activeChar
	 */
