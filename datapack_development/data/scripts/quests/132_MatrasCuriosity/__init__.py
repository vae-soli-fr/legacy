...
# Imported: L2jTW, thx! Update by pmq 08-07-2010
...
class Quest (JQuest) :
	...
	def onTalk (self, npc, player) :
		htmltext = "<html><body>Matras:<br>I have nothing to say to you..</body></html>"
		st = player.getQuestState(qn)
		...
		if id == State.COMPLETED :
			if npcId == MATRAS :
				htmltext = "<html><body>Matras:<br>You already completed this quest!</body></html>"
...
QUEST		= Quest(132, qn, "Matras Curiosity")
