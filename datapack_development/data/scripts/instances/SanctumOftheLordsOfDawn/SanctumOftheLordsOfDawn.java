/**
 * @author d0S. Fixes by Plim, Willow.
 */
...
public class SanctumOftheLordsOfDawn extends Quest
{
    ...
    private static final int MALE_GUARD = 27348;
    private static final int MALE_PRIEST = 27349;
    private static final int FEMALE_PRIEST = 27351;
    private static final int MALE_PRIEST_END = 27350;
    ...
    public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
    {
        if (event.equalsIgnoreCase("Part1"))
        {
            ...
            if (tmpworld instanceof HSWorld)
            {
                ...
                startQuestTimer("Part2", 6000, world.npc1f, null);
                startQuestTimer("Part5", 3000, world.npc1f, null);
            }
        }
        else if (event.equalsIgnoreCase("Part2"))
        {
            ...
            if (tmpworld instanceof HSWorld)
            {
                ...
                startQuestTimer("Part1", 6000, world.npc1f, null);
                startQuestTimer("Part5", 3000, world.npc1f, null);
            }
        }
    ...
    public String onAggroRangeEnter(L2Npc npc, L2PcInstance player, boolean isPet)
    {
        if (npc.getNpcId() == FEMALE_PRIEST)
        {
            ...
            this.startQuestTimer("teleportPlayer", 3000, npc, player);
        }
        //else if (!player.isSilentMoving())
        //{
        //  npc.broadcastPacket(new MagicSkillUse(npc, player, GUARD_SKILL, 1, 2000, 1));
        //  this.startQuestTimer("teleportPlayer", 3000, npc, player);
        //}
