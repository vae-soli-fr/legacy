	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		if (event.equalsIgnoreCase("cf"))
		{
			...
			if (CF >= 1)
			{
				...
				points += trustam;
				saveGlobalQuestVar("life_points", String.valueOf(points));
				htmltext = "<html><body>Galate:<br>Thank for your contribution of Crystal Fragment.</body></html>";
			}
			else
				htmltext = "<html><body>Galate:<br>Incorrect item count..</body></html>";
		}
		else if (event.equalsIgnoreCase("bc"))
		{
			...
			if (BC >= 1)
			{
				...
				points += trustam;
				saveGlobalQuestVar("life_points", String.valueOf(points));
				htmltext = "<html><body>Galate:<br>Thank for your contribution of Blue Crystal.</body></html>";
			}
			else
				htmltext = "<html><body>Galate:<br>Incorrect item count..</body></html>";
		}
		else if (event.equalsIgnoreCase("rc"))
		{
			...
			if (RC >= 1)
			{
				...
				points += trustam;
				saveGlobalQuestVar("life_points", String.valueOf(points));
				htmltext = "<html><body>Galate:<br>Thank for your contribution of Red Crystal.</body></html>";
			}
			else
				htmltext = "<html><body>Galate:<br>Incorrect item count..</body></html>";
		}
		else if (event.equalsIgnoreCase("cc"))
		{
			...
			if (CC >= 1)
			{
				...
				points += trustam;
				saveGlobalQuestVar("life_points", String.valueOf(points));
				htmltext = "<html><body>Galate:<br>Thank for your contribution of Clear Crystal.</body></html>";
			}
			else
				htmltext = "<html><body>Galate:<br>Incorrect item count..</body></html>";
		}
