...
public final class Config
{
    ...
    public static boolean VAEMOD_SHUTUPSEVENSIGNS; // Faire taire les Preachers et Orators
		...
		if(Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			try
			{
				...
				try
				{
                    ...
                    VAEMOD_SHUTUPSEVENSIGNS = Boolean.parseBoolean(customSettings.getProperty("MuteSevenSigns", "false"));
