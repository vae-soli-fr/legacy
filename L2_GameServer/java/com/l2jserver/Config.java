...
public final class Config
{
    ...
    public static int VAEMOD_WHACCOUNTLIMIT; // nombre d'objets en WH par compte
		...
		if(Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			try
			{
				...
				try
				{
                    ...
                    VAEMOD_WHACCOUNTLIMIT = Integer.parseInt(customSettings.getProperty("WarehouseAccountLimit", "1000"));
				}
				catch (Exception e)
				{
					e.printStackTrace();
